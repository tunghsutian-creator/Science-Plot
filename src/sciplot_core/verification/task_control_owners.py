...
TASK_CONTROL_OWNERS = (
    ...
    ChangedOwner(
        ...
        owned_test_paths=frozenset({"tests/test_task_capabilities.py", "tests/test_task_source_update.py", "tests/test_task_source_control.py", "tests/test_task_source_control_native.py", "tests/test_task_review_gallery.py", "tests/test_task_control.py", "tests/test_task_control_native.py", "tests/test_task_recovery.py", "tests/test_task_preview_revision.py", "tests/test_task_revision_guards.py", "tests/test_task_discovery.py", "tests/test_task_groups.py", "tests/test_task_groups_native.py", "tests/test_task_comparisons.py", "tests/test_task_comparisons_native.py"}),
