...
SPECTROSCOPY_RULES: tuple[SemanticRule, ...] = (
    ...
    _rule(
        ...
        AxisSpec(
            ...
            "g/mol",
            "Molar mass (g mol⁻¹)",
            aliases=("molecular weight", "molar mass", "mw"),
            scale="log",
        ),
        AxisSpec(
            ...
            "",
            "dW/dlog M",
            aliases=("dW/dLogM", "dW/dlog M", "weight distribution"),
        ),
        keywords=("gpc", "sec", "molar mass", "molecular weight", "dwdlogm"),
        path_keywords=("/gpc/", "/gpc"),
        column_aliases=("molar mass", "molecular weight", "mw", "dwdlogm"),
        analysis=(
            AnalysisSpec(
                "peak_molar_mass_g_mol",
                (
                    "per-series molar mass at the maximum instrument-exported "
                    "dW/dlog M value"
                ),
                ("molar mass", "dW/dlog M"),
                "g/mol",
            ),
        ),
