        ...
        exact_paths=frozenset(
            {
                ...
                "src/sciplot_core/semantic_sources/rheology_frequency_metrics.py",
                "src/sciplot_core/semantic_sources/rheology_units.py",
        ...
        owned_test_paths=frozenset(
            {
                ...
                "tests/test_rheology_viscosity_unit.py",
