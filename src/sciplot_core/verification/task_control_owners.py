...
TASK_CONTROL_OWNERS = (
    ...
    ChangedOwner(
        ...
        owned_test_paths=frozenset({"tests/test_annotation_operations.py", "tests/test_annotation_operations_native.py"}),
        pytest_targets=("tests/test_annotation_operations.py", "tests/test_annotation_operations_native.py",
